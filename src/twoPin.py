...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setMinimumSize(QtCore.QSize(170, 95))
        Form.setMaximumSize(QtCore.QSize(170, 95))
        self.label_name = QtWidgets.QLabel(Form)
        self.label_name.setGeometry(QtCore.QRect(5, 5, 160, 25))
        ...
        self.frame.setGeometry(QtCore.QRect(5, 30, 160, 60))
